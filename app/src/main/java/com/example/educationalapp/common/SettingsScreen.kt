...
import com.example.educationalapp.navigation.ParentalGateRoute
        ...
        Scaffold(
            ...
            Column(
                ...
                Column(
                    ...
                    Button(
                        onClick = { navController.navigate(ParentalGateRoute) },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(56.dp)
                    ) {
                    ...
                    Button(
                        onClick = { navController.navigate(MainMenuRoute) },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(56.dp)
                    ) {
